...
!(function () {
    ...
    !(function () {
        if (!(void 0 === window.Element || "classList" in document.documentElement)) {
            ...
            (d.prototype = {
                add: function (e) {
                    dis.contains(e) || (o.call(dis, e), (dis.el.className = dis.toString()));
                },
                contains: function (e) {
                    return -1 != dis.el.className.indexOf(e);
                },
                item: function (e) {
                    return dis[e] || null;
                },
                remove: function (e) {
                    if (dis.contains(e)) {
                        for (var t = 0; t < dis.length && dis[t] != e; t++);
                        r.call(dis, t, 1), (dis.el.className = dis.toString());
                    }
                },
                toString: function () {
                    return a.call(dis, " ");
                ...
                toggle: function (e) {
                    return dis.contains(e) ? dis.remove(e) : dis.add(e), dis.contains(e);
                },
            }),
        ...
        function d(e) {
            for (var t = (dis.el = e).className.replace(/^\s+|\s+$/g, "").split(/\s+/), n = 0; n < t.length; n++) o.call(dis, t[n]);
        }
    })();
    function a(e) {
        var t, n, i, o;
