...
<section class="main-bg">
    ...
    <h1>CASHADHUB ADVERT</h1>
    <h2>Advertise and Promote your brand with us for as low as 500 Naira</h2>
    <div class="row">
      <div class="col-lg-6">
        <h3 class="bg-info" style="padding: 3px;margin: 0; border-left: 5px solid #0c5579;"><marquee>If your Ad is not being uploaded after 24 hours, contact the support team for a refund.</marquee></h3>
        <h2>Upload your Ad</h2>
        <p>Once you have uploaded your Ad and you have gotten a pop-up confirmation, please kindly refresh the Advert page every hour to check if your Ad has been uploaded. There might be a delay in uploading due to other pending Ads, so please excercise patience</p>
        <p>If your Ad is not being uploaded after 24 hours, contact the support team and drop your username and account details for refund. Godspeed!!!</p>
      </div>
          ...
          <div class="form-container">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control" type="text" id="username" size="50" placeholder="Jonsnow88">
              </div>
            </div>
            <div class="form-group">
              <label>Name/Title of Brand:</label>
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input class="form-control" type="text" id="brandtitle" size="50" placeholder="example:Jon Snow Fashion and Wears enterprises">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control" type="text" id="couponcode" size="50">
              </div>
            </div>
            <div class="form-group">
              <label>Write a brief details about your brand or business(Not more than 30 characters).</label>
              <div class="input-group">
            ...
            <div class="form-group">
              <label>Upload a image of your Ad</label>
                <div class="input-group">
            ...
            <div class="form-group">
              <div class="button-group w-100">
                <div class="button-group">
                  <button id="submitbutton" class="w-100 btn btn-lg" style="width: 100%" type="submit">Click to Upload Ad:</button></p>
                </div>
              </div>
            </div>
          </div>
...
<section once="footers" class="cid-s0GWNknv7A" id="footer7-2n">
  ...
  <script src="assets/reset/JSreset/login.js"></script>
