...
<head>
  ...
  <link rel="stylesheet" href="assets/reset/CSS-reset/statistics.css">
...
<section class="main">
    <div class="main-box">
        ...
        <div class="box-container">
            ...
            <div class="three">
                <div class="box three-7">
                     <div>
                        <p>5902</p>
                        <h5>Classic Investors</h5>
                    </div>
                    <div>
                        <i class="fad fa-badge-check"></i>
                    </div>
                </div>
                <div class="box three-8">
                     <div>
                        <p>220</p>
                        <h5>Ultimate Investors</h5>
                    </div>
                    <div>
                        <i class="fas fa-user-shield"></i>
                    </div>
                </div>
                <div class="box three-9">
                     <div>
                        <p>562</p>
                        <h5>Master Investors</h5>
                    </div>
                    <div>
